...
func (s *Server) registerProviderRepoAPI(api huma.API) {
	...
	huma.Register(api, huma.Operation{OperationID: "set-pr-assignees", Method: http.MethodPut, Path: pullPath + "/assignees", DefaultStatus: http.StatusOK, Summary: "Set pull request assignees", Tags: []string{"Pull Requests"}}, s.setPullAssignees)
	huma.Register(api, huma.Operation{OperationID: "set-pr-assignees-on-host", Method: http.MethodPut, Path: hostPullPath + "/assignees", DefaultStatus: http.StatusOK, Summary: "Set pull request assignees", Tags: []string{"Pull Requests"}}, s.setPullAssigneesOnHost)
	huma.Register(api, huma.Operation{OperationID: "set-pr-reviewers", Method: http.MethodPut, Path: pullPath + "/reviewers", DefaultStatus: http.StatusOK, Summary: "Set pull request reviewers", Tags: []string{"Pull Requests"}}, s.setPullReviewers)
	huma.Register(api, huma.Operation{OperationID: "set-pr-reviewers-on-host", Method: http.MethodPut, Path: hostPullPath + "/reviewers", DefaultStatus: http.StatusOK, Summary: "Set pull request reviewers", Tags: []string{"Pull Requests"}}, s.setPullReviewersOnHost)
